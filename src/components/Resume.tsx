...
export default function Resume() {
	...
	const bodyStyle = 'w-full bg-white/50 text-sm px-0.5';
	return (
		<div className="flex flex-col gap-10 py-10 pb-20 px-2 bg-white">
			...
			<div>
				...
				<div className="grid grid-cols-[125px_1fr_120px_100px] gap-0.5 mt-2">
			...
			<div>
				...
				<div className="grid grid-cols-[125px_120px_120px_1fr] gap-0.5 mt-2">
			...
			<div>
				...
				<div className="grid grid-cols-[100px_1fr_150px] gap-0.5 mt-2">
